...
setup(
    name='feirasapi',
    version='1.0',
    packages=['venv.lib.python3.5.site-packages.pytz', 'venv.lib.python3.5.site-packages.click',
              'venv.lib.python3.5.site-packages.flask', 'venv.lib.python3.5.site-packages.flask.ext',
              'venv.lib.python3.5.site-packages.jinja2', 'venv.lib.python3.5.site-packages.dateutil',
              ...
              'venv.lib.python3.5.site-packages.werkzeug.contrib', 'venv.lib.python3.5.site-packages.aniso8601',
              'venv.lib.python3.5.site-packages.packaging', 'venv.lib.python3.5.site-packages.sqlalchemy',
    ...
    url='http://www.github.com/jonasgmachado/feirasapi',
    license='',
    author='jonas',
    author_email='jonasgmachado@gmail.com',
    description=''
)
